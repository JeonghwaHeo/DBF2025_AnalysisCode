...
from src.vsp_analysis import VSPAnalyzer, writeAnalysisResults
from src.internal_dataclass import *


def runVSPGridAnalysis(aircraftParamConstraint: AircraftParamConstraints,aerodynamicSetup: AerodynamicSetup, presetValues: PresetValues, 
                       baseAircraft: Aircraft, server_id : int=1, total_server : int=1,csvPath: str = "",vspPath: str=""):
