...
if os.path.exists(f"data/mission2_server{server}_results.csv"):
    os.remove(f"data/mission2_server{server}_results.csv")
if os.path.exists(f"data/mission3_server{server}_results.csv"):
    os.remove(f"data/mission3_server{server}_results.csv")    
